...
# --- Setup ---
res.dir <- "~/Documents/Motion-Profiling/analyses/NC_GroupEffects_NCvsSCZ/results/"
setwd(res.dir)
datasets <- list.files(pattern = "NCvsSCZ_permutations_corticalROI.*\\.csv$")
...
# --- Save results ---
out_file <- file.path(res.dir, "GroupEffect_NCvsSCZ_corticalROI_meta_analysis.csv")
